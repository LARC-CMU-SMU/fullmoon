...
general = dict(
    ...
    wait_time_for_db=1,
    mails_per_day=10,
    handle_newly_occupied_thread_sleep_time=20,  # seconds
    calculate_optimized_lux_thread_sleep_time=30,  # seconds
    set_optimized_dc_in_device_thread_sleep_time=30,  # seconds
